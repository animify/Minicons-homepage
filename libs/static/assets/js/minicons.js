    ...
    _createClass(MiniconsHandler, [{
        ...
        value: function create(name, props) {
            ...
            if (iconObject.hasOwnProperty('fillTag')) {
                var fillables = Array.prototype.slice.call(svg.getElementsByTagName(iconObject.fillTag));
                fillables.forEach(function (element) {
